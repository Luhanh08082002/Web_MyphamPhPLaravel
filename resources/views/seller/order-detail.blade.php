                                    ...
                                    <tbody>
                                        @foreach ($Product as $value)
                                            <tr>
                                                ...
                                                <td><img src="{{ URL::to('public/Upload/Product/' . $value->ProductImage1 . '') }}"
                                                        alt="product-img" height="32"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="font-weight-bold">{{ $Order_detail->OrderTotal }} VNĐ</div>
                                            </td>
                                        </tr>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-2"><span class="font-weight-semibold mr-2">Địa chỉ :</span>
                                {{ $Order_detail->ShippingAddress }}</p>
                            <p class="mb-2"><span class="font-weight-semibold mr-2">Số điện thoại :</span>
                                {{ $Order_detail->ShippingPhone }}</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <p class="mb-2"><span class="font-weight-semibold mr-2">Phương thức thanh
                                            toán:</span>{{ $Order_detail->PaymentMethod }}</p>
                                    <p class="mb-1"><span class="font-weight-semibold">Mã Đơn
                                            :</span>HĐ-{{ $Order_detail->OrderID }}</p>
                                    @if ($Order_detail->PaymentStatus == 1)
                                        <p class="mb-0"><span class="font-weight-semibold">Thanh toán :</span> Đã thanh
                                            toán</p>
                                    @endif
                                    @if ($Order_detail->PaymentStatus == 0)
                                        <p class="mb-0"><span class="font-weight-semibold">Thanh toán :</span> Chưa thanh
                                            toán</p>
                                    @endif
