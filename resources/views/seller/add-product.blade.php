                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="product-reference" name="price" class="form-control"
                                    placeholder="Giá">
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card-box">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="quanty" id="product-name" class="form-control"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="radio form-check-inline">
                                    <input type="radio" id="inlineRadio1" value="1" name="productStatus"
                                        checked="">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <br />
                                <div class="radio form-check-inline">
                                    <input type="radio" id="inlineRadio3" value="0" name="chienluoc"
                                        checked="">
