    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            @foreach ($edit_pro as $key => $value)
                <form class="" action="{{ URL::to('/update-product-data') }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-box">
                                    ...
                                    <select class="form-control select2" name="cateID" id="product-category">
                                        @foreach ($catePro as $key => $valueCate)
                                            @if ($valueCate->CategoryID == $value->CategoryID)
                                                <option selected value="{{ $valueCate->CategoryID }}">
                                                    {{ $valueCate->CategoryName }}</option>
                                            @else
                                                <option value="{{ $valueCate->CategoryID }}">{{ $valueCate->CategoryName }}
                                                </option>
                                            @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <label for="product-category">Thương hiệu sản phẩm <span
                                    ...
                                    <select class="form-control select2" name="brandID" id="product-category">
                                        @foreach ($brandPro as $key => $valueBrand)
                                            @if ($valueBrand->BrandID == $value->BrandID)
                                                <option selected value="{{ $valueBrand->BrandID }}">
                                                    {{ $valueBrand->BrandName }}</option>
                                            @else
                                                <option value="{{ $valueBrand->BrandID }}">{{ $valueBrand->BrandName }}
                                                </option>
                                            @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" name="productName"
                                        value="{{ $value->ProductName }}" class="form-control" placeholder="Tên sản phẩm">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-reference">Giá<span class="text-danger">*</span></label>
                                    <input type="text" id="product-reference" name="price"
                                        value="{{ $value->ProductPrice }}" class="form-control" placeholder="Giá">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <label for="product-description">Chi tiết sản phẩm<span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="productDes" id="product-description" rows="5"
                                        placeholder="Please enter description">{{ $value->ProductDescrip }}</textarea>
                                </div>
                            ...
                            <div class="card-box">
                                ...
                                <div class="form-group mb-3">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ URL::to('public/Upload/Product/' . $value->ProductImage1 . '') }}" height="100"
                                            width="80" alt="" />
                                ...
                                <div class="form-group mb-3">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ URL::to('public/Upload/Product/' . $value->ProductImage2 . '') }}" height="100"
                                            width="80" alt="" />
                                ...
                                <div class="form-group mb-3">
                                    <div class="fallback">
                                        ...
                                        <img src="{{ URL::to('public/Upload/Product/' . $value->ProductImage3 . '') }}" height="100"
                                            width="80" alt="" />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="quanty" id="product-name"
                                        value="{{ $value->ProductQuanty }}" class="form-control" placeholder="Số lượng">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="product-name">Màu sắc sản phẩm <span class="text-danger">*</span></label>
                                    <input type="text" id="product-name" name="color" class="form-control"
                                        value="{{ $value->ProductColor }}" placeholder="Màu sản phẩm">
                                </div>
                                ...
                                <div class="text-center mb-3" style="padding-top:185px">
                                    ...
                                    <button type="submit" class="btn w-sm btn-success waves-effect waves-light">Cập
                                        nhật</button>
                                </div>
