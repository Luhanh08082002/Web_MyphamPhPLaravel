                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ URL::to('/admin-dashboard') }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="email" name="email_admin" id="emailaddress"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="password" name="pass_admin" class="form-control"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50 ml-1">Bạn là seller ?</p>
                            <a class="text-white ml-1" href="{{ URL::to('/seller/login') }}">Đăng nhập seller</a>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p> <a href="auth-recoverpw.html" class="text-white-50 ml-1">Quên mật khẩu ?</a></p>
                            <p class="text-white-50">Bạn chưa có tài khoản ? <a href="auth-register.html"
                                    class="text-white ml-1"><b>Đăng kí</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
